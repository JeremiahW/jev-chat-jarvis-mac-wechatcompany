...
class InputTargetTests(unittest.TestCase):
    ...
    def test_changed_target_never_writes(self):
        ...
        with patch.object(fill, 'has_accessibility', return_value=True), patch.object(fill, '_target_app', return_value=Mock()), patch.object(fill, 'locate_input', return_value=new), patch.object(fill, '_ax_set_value') as write:
